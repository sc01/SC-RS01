...
namespace Sign.Models.Business
{
    public class BigManger
    {
        ...
        public List<ScForBigManger> ScForBigMangers { get; set; } = new List<ScForBigManger>();

        public List<AttachmentForBigManger> AttachmentForBigMangers { get; set; } = new List<AttachmentForBigManger>();
